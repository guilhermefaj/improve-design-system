...
const meta = {
  title: "03 Molecules/carousel",
  component: ComponentDocumentation,
  tags: ["autodocs","data-display","molecule"],
  args: { componentId: "carousel", variant: "default", state: "active", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
    componentId: { control: false, table: { disable: true } },
    variant: { control: 'select', options: ["default"] },
    state: { control: 'select', options: ["active"] },
    theme: { control: 'inline-radio', options: ['light', 'dark'] },
    motion: { control: 'inline-radio', options: ['none', 'subtle', 'expressive'] },
    disabled: { control: 'boolean' },
  },
  parameters: { docs: { description: { component: "Carrossel de slides com navegação por teclado." } }, componentId: "carousel" },
} satisfies Meta<typeof ComponentDocumentation>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Playground: Story = {};
export const Variants: Story = { args: { variant: "default" } };
export const States: Story = { args: { state: "active" } };
