...
const meta = {
  title: "03 Molecules/collapsible",
  component: ComponentDocumentation,
  tags: ["autodocs","overlay","molecule"],
  args: { componentId: "collapsible", variant: "default", state: "open", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
  ...
  parameters: { docs: { description: { component: "Disclosure único que mostra ou oculta uma região de conteúdo." } }, componentId: "collapsible" },
