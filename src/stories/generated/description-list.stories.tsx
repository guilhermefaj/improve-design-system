...
const meta = {
  title: "03 Molecules/description-list",
  component: ComponentDocumentation,
  tags: ["autodocs","data-display","molecule"],
  args: { componentId: "description-list", variant: "stacked", state: "default", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
  ...
  parameters: { docs: { description: { component: "Lista de termos e definições para metadados e resumos chave-valor." } }, componentId: "description-list" },
