...
const meta = {
  ...
  tags: ["autodocs","foundation","atom"],
  args: { componentId: "logo", variant: "mark", state: "default", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
  ...
  parameters: { docs: { description: { component: "Marca vetorial responsiva para interfaces e Artifacts." } }, componentId: "logo" },
} satisfies Meta<typeof ComponentDocumentation>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Playground: Story = {};
export const Variants: Story = { args: { variant: "wordmark" } };
