...
const meta = {
  title: "03 Molecules/table",
  component: ComponentDocumentation,
  tags: ["autodocs","data-display","molecule"],
  args: { componentId: "table", variant: "default", state: "default", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
  ...
  parameters: { docs: { description: { component: "Primitivos de tabela para composição com DataTable." } }, componentId: "table" },
