...
const meta = {
  title: "02 Atoms/label",
  component: ComponentDocumentation,
  tags: ["autodocs","form","atom"],
  args: { componentId: "label", variant: "default", state: "default", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
  ...
  parameters: { docs: { description: { component: "Rótulo acessível reutilizável para controles de formulário." } }, componentId: "label" },
