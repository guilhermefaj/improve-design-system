...
const meta = {
  ...
  tags: ["autodocs","navigation","atom"],
  args: { componentId: "item", variant: "default", state: "selected", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
    componentId: { control: false, table: { disable: true } },
    variant: { control: 'select', options: ["default","selected"] },
    state: { control: 'select', options: ["selected","hover","focus-visible"] },
    theme: { control: 'inline-radio', options: ['light', 'dark'] },
    motion: { control: 'inline-radio', options: ['none', 'subtle', 'expressive'] },
    disabled: { control: 'boolean' },
  },
  parameters: { docs: { description: { component: "Linha reutilizável para listas, menus e seletores." } }, componentId: "item" },
} satisfies Meta<typeof ComponentDocumentation>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Playground: Story = {};
export const Variants: Story = { args: { variant: "selected" } };
