...
const meta = {
  title: "01 Foundations/scroll-area",
  component: ComponentDocumentation,
  tags: ["autodocs","foundation"],
  args: { componentId: "scroll-area", variant: "vertical", state: "default", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
  ...
  parameters: { docs: { description: { component: "Região com rolagem contida e limite de altura para listas e painéis." } }, componentId: "scroll-area" },
