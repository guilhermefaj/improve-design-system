...
5. Consultar o manifesto ou executar `improve-ds list --json` e `improve-ds inspect <id> --json`. Reutilizar componentes existentes antes de criar novos. O manifesto v3 informa `primaryExport`, `category`, arquivos, dependências e o starter exato de cada recipe.
...
- Usar Edu NSW ACT Cursive apenas como acento expressivo raro.
...
- Agrupar e escolher componentes pela `category` do manifesto (form, overlay, agentic, …). O specimen lista tudo em catálogo plano com âncora `#id`.
