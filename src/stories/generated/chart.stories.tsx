...
const meta = {
  title: "02 Atoms/chart",
  component: ComponentDocumentation,
  tags: ["autodocs","data-display","atom"],
  args: { componentId: "chart", variant: "bar", state: "default", theme: 'light', motion: 'subtle', disabled: false },
  argTypes: {
    componentId: { control: false, table: { disable: true } },
    variant: { control: 'select', options: ["bar","line"] },
    state: { control: 'select', options: ["default"] },
    theme: { control: 'inline-radio', options: ['light', 'dark'] },
    motion: { control: 'inline-radio', options: ['none', 'subtle', 'expressive'] },
    disabled: { control: 'boolean' },
  },
  parameters: { docs: { description: { component: "Série simples em barra ou linha para tendências compactas." } }, componentId: "chart" },
} satisfies Meta<typeof ComponentDocumentation>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Playground: Story = {};
export const Variants: Story = { args: { variant: "line" } };
