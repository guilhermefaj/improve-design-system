...
const meta = {
  ...
  argTypes: {
    ...
    state: { control: 'select', options: ["verified","unverified"] },
    theme: { control: 'inline-radio', options: ['light', 'dark'] },
    motion: { control: 'inline-radio', options: ['none', 'subtle', 'expressive'] },
    disabled: { control: 'boolean' },
  },
  parameters: { docs: { description: { component: "Fontes verificáveis associadas ao resultado." } }, componentId: "citation-list" },
} satisfies Meta<typeof ComponentDocumentation>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Playground: Story = {};
export const Variants: Story = { args: { variant: "detailed" } };
export const States: Story = { args: { state: "unverified" } };
